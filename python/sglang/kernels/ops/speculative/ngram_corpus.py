...
def get_ngram_corpus_cls():
    ...
    class NgramCorpusFFI(tvm_ffi.Object):
        ...
        def match_stateful(
            ...
            out_depths = torch.zeros(batch_size, dtype=torch.int32)
            ...
            # tokens / mask are widened because they end up in int64 torch
            # tensors; the depths only ever become a Python list.
            return (
